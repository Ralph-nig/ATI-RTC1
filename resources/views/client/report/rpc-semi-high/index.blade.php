    ...
    <div class="details">
        ...
        <div class="rpc-semi-content">
            ...
            <div class="filters-section">
                <form method="GET" action="{{ route('client.report.rpc-semi-high') }}" class="filters-form">
                    ...
                    <div class="filter-actions">
                        ...
                        <a href="{{ route('client.report.rpc-semi-high') }}" class="btn btn-secondary"><i class="fas fa-redo"></i> Reset</a>
                    </div>
                </form>
            </div>
            ...
            <div class="filters-section" style="margin-top:-8px;">
                <form method="GET" action="{{ route('client.report.rpc-semi-high') }}" class="filters-form">
                    ...
                    <div class="filter-actions">
                        ...
                        <a href="{{ route('client.report.rpc-semi-high') }}" class="btn btn-secondary">Reset</a>
                    </div>
                </form>
            </div>
            ...
            @if($groupedEquipment->count() > 0)
                ...
                @include('client.report._export_fab', [
                    'excelUrl' => route('client.report.rpc-semi-high.export.excel', request()->query()),
                    'pdfUrl'   => route('client.report.rpc-semi-high.export.pdf',   request()->query())
                ])
            @else
                <div class="empty-state">
                    <i class="fas fa-box-open"></i>
                    <h3>No Equipment Found</h3>
                    <p>There are no semi-expendable properties with high value (&#8369;50,000 and above) to display.</p>
                </div>
            @endif
