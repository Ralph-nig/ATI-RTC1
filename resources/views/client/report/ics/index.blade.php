            ...
            <div class="supplies-container">
                ...
                <div class="supplies-table-container">
                    @if($equipment->count() > 0)
                        <table class="supplies-table" id="icsTable">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>ICS No.</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><strong>₱{{ number_format($item->unit_value * ($item->quantity ?? 1), 2) }}</strong></td>
                                    ...
                                    <td style="text-align:center;">
                                        <a href="{{ route('client.report.ics.print', $item->id) }}"
                                           target="_blank" class="btn-print">
                                            <i class="fas fa-print"></i> Print ICS
                                        </a>
                                    </td>
                                </tr>
                                @endforeach
                    ...
                    @else
                        <div class="empty-state">
                            <i class="fas fa-clipboard-check"></i>
                            <h3>No ICS Records Found</h3>
                            <p>No equipment with unit value below ₱50,000 found.</p>
                        </div>
                    @endif
                </div>
            </div>
    ...
    <script>
        $(document).ready(function () {
            $('#searchInput').on('keyup', function () {
                ...
                $('#icsTable tbody tr').filter(function () {
