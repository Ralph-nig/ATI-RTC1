                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="category" name="category" class="form-input" 
                                           value="{{ old('category') }}" placeholder="e.g., Office Supplies, Equipment" 
                                           list="categories">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" id="quantity" name="quantity" class="form-input" 
                                           value="{{ old('quantity', 0) }}" min="0" required placeholder="0">
                                </div>
                                @error('quantity')
                                    <div class="error-message">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" id="unit_price" name="unit_price" class="form-input" 
                                           value="{{ old('unit_price', '0.00') }}" step="0.01" min="0" required placeholder="0.00">
                                </div>
                                @error('unit_price')
                                    <div class="error-message">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" id="minimum_stock" name="minimum_stock" class="form-input" 
                                           value="{{ old('minimum_stock', 5) }}" min="0" required placeholder="5">
                                </div>
                            ...
                            <div class="form-group full-width">
                                ...
                                <textarea id="description" name="description" class="form-input form-textarea" 
                                          placeholder="Enter item description, specifications, or other details">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="error-message">{{ $message }}</div>
                                @enderror
                            </div>
